...
with open("./dataprocessing/hbbTopSourceDatasets.csv", "rU") as f:
    lines = f.readlines()
...
for sourceDatasetWithFlag in sourceDatasetsWithFlags:
    ...
    for line in output.readlines():
        if "/projecta/projectdirs/atlas/" in line:
            ...
            os.popen("cp " + filepath + " ./hbbTopDatasets/")

            oldFileName = filepath.split("/")[-1]
            newFileName = oldFileName.split('.h5')[0] + "_" + dsid + "_" + flag + ".h5"

            os.popen("mv ./hbbTopDatasets/" + oldFileName + " ./hbbTopDatasets/" + newFileName)
