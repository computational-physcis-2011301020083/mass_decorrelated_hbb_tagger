...
for filePath in filePaths:
  ...
  newDf["weight_test"]=newDf["mcEventWeight"]*list5[sourceDataset.split("_")[2]]
  newDf["weight"]=newDf["weight_test"]  
  print "ready"
  newDfFilePath = "/global/project/projectdirs/atlas/massDecorrelatedXbb/adversarial-wei1/datasets/ReducedDijetsDatasets/" + sourceDataset
