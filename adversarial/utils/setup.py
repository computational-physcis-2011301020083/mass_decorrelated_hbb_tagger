...
# INPUT_VARIABLES = ['pt', 'Tau32', 'e3', 'Qw', 'eta', 'Tau21', 'C2', 'D2','Tau21', 'C2', 'D2', 'Angularity', 'Aplanarity', 'FoxWolfram20', 'KtDR', 'PlanarFlow', 'Split12', 'ZCut12', 'IP2D_pb_1', 'IP2D_pc_1', 'IP2D_pu_1', 'IP3D_pb_1', 'IP3D_pc_1', 'IP3D_pu_1', 'JetFitter_dRFlightDir_1', 'JetFitter_deltaeta_1', 'JetFitter_deltaphi_1', 'JetFitter_energyFraction_1', 'JetFitter_mass_1', 'JetFitter_massUncorr_1', 'JetFitter_significance3d_1', 'SV1_L3d_1', 'SV1_Lxy_1', 'SV1_deltaR_1', 'SV1_dstToMatLay_1', 'SV1_efracsvx_1', 'SV1_masssvx_1', 'SV1_significance3d_1', 'deta_1', 'dphi_1', 'dr_1', 'eta_1', 'pt_1', 'rnnip_pb_1', 'rnnip_pc_1', 'rnnip_ptau_1', 'rnnip_pu_1', 'JetFitter_nSingleTracks_1', 'JetFitter_nTracksAtVtx_1', 'JetFitter_nVTX_1', 'JetFitter_N2Tpair_1', 'SV1_N2Tpair_1', 'SV1_NGTinSvx_1', 'IP2D_pb_2', 'IP2D_pc_2', 'IP2D_pu_2', 'IP3D_pb_2', 'IP3D_pc_2', 'IP3D_pu_2', 'JetFitter_dRFlightDir_2', 'JetFitter_deltaeta_2', 'JetFitter_deltaphi_2', 'JetFitter_energyFraction_2', 'JetFitter_mass_2', 'JetFitter_massUncorr_2', 'JetFitter_significance3d_2', 'SV1_L3d_2', 'SV1_Lxy_2', 'SV1_deltaR_2', 'SV1_dstToMatLay_2', 'SV1_efracsvx_2', 'SV1_masssvx_2', 'SV1_significance3d_2', 'deta_2', 'dphi_2',                    'dr_2', 'eta_2', 'pt_2', 'rnnip_pb_2', 'rnnip_pc_2', 'rnnip_ptau_2', 'rnnip_pu_2', 'JetFitter_nSingleTracks_2', 'JetFitter_nTracksAtVtx_2', 'JetFitter_nVTX_2',     'JetFitter_N2Tpair_2', 'SV1_N2Tpair_2', 'SV1_NGTinSvx_2']
INPUT_VARIABLES = ['pt', 'Tau32', 'e3', 'Qw', 'eta', 'Tau21', 'C2', 'D2','Tau21', 'C2', 'D2', 'Angularity', 'Aplanarity', 'FoxWolfram20', 'KtDR', 'PlanarFlow', 'Split12', 'ZCut12']
...
def load_data (path, name='dataset', train=None, test=None, signal=None, background=None, sample=None, seed=21, replace=True):
    ...
    try:
        for sig, name in zip([1, 0], ['signal', 'background']):
            print "Found {:8.0f} training and {:8.0f} test samples for {}".format(
